...
> **Development version:** `0.14.0.dev0` — Scientific workflow integration (I0–I2 implemented; I3–I7 planned)
...
and captures full evaluator contexts with isolated execution. End-to-end references
and reports remain planned for I3–I6. Existing APIs and physics are preserved.
...
| v0.14.0 | Scientific workflow integration: fitting/calibration → DTCO → Robust DTCO | I0–I2 implemented; I3–I7 planned |
