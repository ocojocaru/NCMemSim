...
> **Development status:** J3 adds isolated, opt-in image-force barrier corrections with raw-barrier diagnostics; engine integration remains disabled.
...
| Advanced transport | J1 trap contracts, J2 isolated compact TAT kernel and J3 opt-in image-force barrier corrections; engine integration is not implemented yet |
...
| v1.1.0 | Advanced transport physics: trap/defect contracts and opt-in mechanisms | **J3 complete; J4 next** |
