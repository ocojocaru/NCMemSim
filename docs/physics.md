...
NCMemSim v0.14.0 implements a compact multiphysics model for distributed
...
The compact physics retained in v0.14.0 does not include all mechanisms that
...
These limitations define the interpretation range of v0.14.0 results and
