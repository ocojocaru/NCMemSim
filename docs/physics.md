...
NCMemSim v1.0.0 implements a compact multiphysics model for distributed
...
The compact physics retained in v1.0.0 does not include all mechanisms that
...
These limitations define the interpretation range of v1.0.0 results and
