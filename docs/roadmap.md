...
- spectral and monochromatic light-source descriptions;
- wavelength-dependent absorption and generation;
- electrical, optical, and electro-optical programming modes;
- optical-programming regression cases.

### v0.11.0: Experimental fitting

- import of experimental C–V and retention data;
- objective functions and parameter bounds;
- deterministic optimization workflows;
- fit diagnostics, uncertainty, and parameter provenance.

### v0.12.0: Design-space exploration

- parameter sweeps and structured experiment definitions;
...
Potential post-v1.0 extensions include trap-assisted transport, image-force effects, quantum confinement, stochastic nanocrystal ensembles, temperature dependence, uncertainty propagation, neuromorphic programming metrics, and accelerated numerical backends.
