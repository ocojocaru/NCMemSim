...
- Preparation package version: `0.14.0`
- Gate status: `passed`
...
This step marks `clean_installed_distributions` as passed and makes `ready_for_candidate=true` because all approved review gates and final candidate checks now have retained evidence. It does not create a v1.0 tag, GitHub release, Pages deployment, DOI or external archival deposit.
